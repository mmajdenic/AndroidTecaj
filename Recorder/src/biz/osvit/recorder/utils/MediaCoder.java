package biz.osvit.recorder.utils;
...
public class MediaCoder {
    ...
    public interface OutputFormatChangedListener {
        void outputFormatChanged(MediaCoder sender, MediaFormat newFormat);
    }
    ...
    public interface OutputSampleListener {
        void outputSample(MediaCoder sender, MediaCodec.BufferInfo info, ByteBuffer buffer);
    }
    ...
    private MediaCoder(MediaCodec codec) {
        mDecoder = codec;
        codec.start();
    ...
    /**
     * Constructs the {@link MediaCoder} wrapper object around the video codec.
     ...
     * @return
     */
    public static MediaCoder fromVideoFormat(final MediaFormat trackFormat,
            Surface surface) {
        MediaCoder result = null;
        ...
        // newly created codec.
        if (videoCodec != null) {
            result = new MediaCoder(videoCodec);
        }
    ...
    public boolean writeSample(final ByteBuffer input,
        ...
        if (size > 0 &&  !mAvailableInputBuffers.isEmpty()) {
            ...
            if (size > buffer.capacity()) {
                throw new MediaCoder.WriteException(String.format(
     ...
     * OutputSampleListener#outputSample(MediaCoder, android.media.MediaCodec.BufferInfo,
     * java.nio.ByteBuffer)}
     *
                        ...
                        mHandler.post(new Runnable() {
                            ...
                            public void run() {
                                mOutputFormatChangedListener
                                        .outputFormatChanged(MediaCoder.this,
